"""
URL configuration for superecommercejangoproject project.
...
urlpatterns = [
    ...
    path('add-product/', user_views.add_products, name='add-products-page'),
    path('products/', user_views.all_products, name='all_products'),
    path('del-prod/<id>', user_views.delete_products, name='delete-prod'),
